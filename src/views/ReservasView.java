	...
	public ReservasView() {
		...
		txtFechaSalida.addPropertyChangeListener(new PropertyChangeListener() {
			public void propertyChange(PropertyChangeEvent evt) {
				txtValor.setText(String.valueOf(valorNoche * valorEstadia()));
			}
		});
		...
		btnsiguiente.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				if (ReservasView.txtFechaEntrada.getDate() != null && ReservasView.txtFechaSalida.getDate() != null) {
					...
					Date DFE = new java.sql.Date(txtFechaEntrada.getDate().getTime());
					Date DFS = new java.sql.Date(txtFechaSalida.getDate().getTime());
					
					int reservaId = crud.insert( DFE, DFS,
